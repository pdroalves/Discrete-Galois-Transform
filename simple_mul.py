...
from galois import GaussianInteger, modinv
...
nthroots = {
    ...
    512:GaussianInteger(5809945479226292735, 4344400649288295733),
    1024:GaussianInteger(1973388244086427726, 10274180581472164772),
    2048:GaussianInteger(2796647310976247644, 10276259027288899473),
    4096:GaussianInteger(1838446843991, 11906871093314535013)
}

invNthroots = {
    # 256:GaussianInteger(16074635847813643139, 1012656084342873654)
...
def dgt_gentlemansande_mul(a, b):
    ...
    print ["%d, %d,"% (x.re, x.imag) for x in c_h]
